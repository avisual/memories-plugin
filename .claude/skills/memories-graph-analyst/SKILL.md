...
## Step 0: Diagnostic hypothesis

Before running any queries or reading any code, state in 2-3 sentences:
- What you expect to find based on prior findings recalled in Step 1
- Which area is highest-risk
- What a successful audit would confirm
