    ...
    "PreToolUse": [
        {
            ...
            "hooks": [
                {
                    "type": "command",
                    "command": f"{sys.executable} -m memories hook pre-tool",
                    "timeout": 10,
                },
            ],
        },
    ...
    "SubagentStop": [
        {
            "hooks": [
                {
                    "type": "command",
                    "command": f"{sys.executable} -m memories hook subagent-stop",
                    "timeout": 30,
                },
            ],
        },
    ...
    "TeammateIdle": [
        {
            "hooks": [
                {
                    "type": "command",
                    "command": f"{sys.executable} -m memories hook teammate-idle",
                    "timeout": 10,
                },
            ],
        },
